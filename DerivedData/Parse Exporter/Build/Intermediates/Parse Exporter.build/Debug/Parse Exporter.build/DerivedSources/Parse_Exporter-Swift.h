...
SWIFT_CLASS("_TtC14Parse_Exporter11AppDelegate")
...
SWIFT_CLASS("_TtC14Parse_Exporter14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, strong) IBOutlet NSTextField * _Null_unspecified displayTextField;
- (void)viewDidLoad;
- (IBAction)openFileAction:(id _Nonnull)sender;
